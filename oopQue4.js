...
// Rectangle inherit from shape also 
class Rectangle extends Shape{
 ...
 // Triangle inherit from shape class 
class Triangle extends Shape{
    constructor (base , height ,sidel, side1,side2,side3){
        super();
        this.type=" Triangle ";
        this.base=base;
        this.height=height;
...
Perimeter : ${ rectangle.calculatePerimeter()}`);
 ...
 const triangle=new Triangle(3,5,6,8,20);
